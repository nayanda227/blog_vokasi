                  ...
                  ?>
                    ...
                    <td><?php echo $no;?></td>
                      ...
                      <a href="edittag.php?data=<?php echo $id_tag;?>"class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $tag; ?>?'))window.location.href ='tag.php?aksi=hapus&data=<?php echo $id_tag;?>&notif=hapusberhasil'" 
                      ...
                      if (isset($_GET["katakunci"])){
                          ...
                          for($i=1; $i<=$jum_halaman; $i++){
                            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                               if($i!=$halaman){
                                  echo "<li class='page-item'><a class='page-link' 
                                  href='tag.php?katakunci=$katakunci_tag&halaman=$i'>
                                  $i</a></li>";
                               }else{
                                  echo "<li class='page-item'>
