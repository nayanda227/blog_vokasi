                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>?'))window.location.href ='kategoriblog.php?aksi=hapus&data=<?php echo $id_kategori_blog;?>&notif=hapusberhasil'" 
